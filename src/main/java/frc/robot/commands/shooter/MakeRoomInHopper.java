...
public class MakeRoomInHopper extends CommandBase {
  private Shooter m_shooter;
  /**
   * Creates a new MakeRoomInHopper.
   */
  public MakeRoomInHopper(Shooter shooter) {
      m_shooter = shooter;
  ...
  public void end(boolean interrupted) {
    m_shooter.driveAgitator(0.0);
    m_shooter.driveFeeder(0.0);
    m_shooter.driveFeeder(0.0);
  }
